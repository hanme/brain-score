# metric that is very specific to the Rajalingham2019 benchmark
...
class DeltaPrediction(Metric):
    def __init__(self):
        ...
        brainscore_vision.load_metric('ridge')  # load regression_correlation plugin to make sure we can import
