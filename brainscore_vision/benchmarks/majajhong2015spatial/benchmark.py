...
from brainscore_vision.metrics.spatial_response_correlation.spatial_correlation import inv_ks_similarity
from brainscore_vision.model_interface import BrainModel
from brainscore_vision.utils import LazyLoad
from ..majajhong2015.benchmark import BIBTEX

SPATIAL_BIN_SIZE_MM = .1  # arbitrary choice


class MajajHong2015ITSpatialCorrelation(BenchmarkBase):
    def __init__(self):
        """
